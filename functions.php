...
if ( ! function_exists( 'yaurau_theme_setup' ) ) :
	/**
	 ...
	 */
	function yaurau_theme_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on yaurau-theme, use a find and replace
		 * to change 'yaurau-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'yaurau-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'yaurau-theme' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'yaurau_theme_custom_background_args', array(
...
add_action( 'after_setup_theme', 'yaurau_theme_setup' );
 ...
 */
function yaurau_theme_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'yaurau_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'yaurau_theme_content_width', 0 );
 ...
 */
function yaurau_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'yaurau-theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'yaurau-theme' ),
...
function yaurau_theme_scripts() {
    ...
    wp_register_script('yaurau-theme-script-uikit', get_template_directory_uri(). '/assets/uikit/uikit.js',array(), false, true);
